...
# fraud_transactions_dataset documentation build
...
from fraud_transactions_dataset import __version__ as release

# -- Project information -----------------------------------------------------

project = "fraud_transactions_dataset"
author = "Kedro"
...
htmlhelp_basename = "fraud_transactions_datasetdoc"
...
latex_documents = [
    (
        master_doc,
        "fraud_transactions_dataset.tex",
        "fraud_transactions_dataset Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "fraud_transactions_dataset",
        "Project fraud_transactions_dataset codebase.",
        "Data-Science",
    )
]
